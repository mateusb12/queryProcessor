...
account_table = pd.read_csv("outputs/account.csv")
transaction_type_table = pd.read_csv("outputs/transaction_type.csv")
category_table = pd.read_csv("outputs/category.csv")
print(random_table)